...
import type{ PropertyInsert,  PropertiesResponse, Property} from "../../interfaces/property-interface.js";
...
export class PropertiesService {
  ...
  constructor() {
	...
	async insertProperty(property: PropertyInsert) : Promise<Property> {
		const resp = await this.#http.post<Property, PropertyInsert>(SERVER + "/properties", property);
		return resp;
	}
